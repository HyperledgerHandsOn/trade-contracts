...
export class TradeContract extends Contract {
    ...
    constructor() {
        ...
        this.aclRules[TradeContract.getAclSubject('ExportingEntityOrgMSP', 'any')] = [ 'init' ];
        this.aclRules[TradeContract.getAclSubject('ExporterOrgMSP', 'exporter')] = [ 'acceptTrade', 'exists', 'getTrade', 'getTradeStatus', 'listTrade' ];
        this.aclRules[TradeContract.getAclSubject('ExportingEntityOrgMSP', 'exporter')] = [ 'acceptTrade', 'exists', 'getTrade', 'getTradeStatus', 'listTrade' ];
